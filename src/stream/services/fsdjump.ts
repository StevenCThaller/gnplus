...
import ConflictFactionRepository from "@api/repositories/conflictFaction.repository";
import ConflictStatusRepository from "@api/repositories/conflictStatus.repository";
import ConflictWarTypeRepository from "@api/repositories/conflictWarType.repository";
import HappinessRepository from "@api/repositories/happiness.repository";
import PendingStateRepository from "@api/repositories/pendingState.repository";
import PowerRepository from "@api/repositories/power.repository";
import PowerplayStateRepository from "@api/repositories/powerplayState.repository";
import PrimarySystemFactionRepository from "@api/repositories/primarySystemFaction.repository";
import RecoveringStateRepository from "@api/repositories/recoveringState.repository";
import SecurityLevelRepository from "@api/repositories/securityLevel.repository";
import StarSystemRepository from "@api/repositories/starSystem.repository";
import SystemConflictRepository from "@api/repositories/systemConflict.repository";
import SystemEconomyRepository from "@api/repositories/systemEconomy.repository";
import SystemFactionRepository from "@api/repositories/systemFaction.repository";
import ThargoidWarRepository from "@api/repositories/thargoidWar.repository";
import ThargoidWarStateRepository from "@api/repositories/thargoidWarState.repository";
